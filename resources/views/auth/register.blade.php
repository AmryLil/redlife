    ...
    <div
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div>
                ...
                <x-input id="name" class="block py-2 px-2 border mt-1 w-full" type="text" name="name"
                    :value="old('name')" required autofocus autocomplete="name" />
            </div>

            <div class="mt-4">
                <x-label for="email" value="{{ __('Email') }}" />
                <x-input id="email" class="block py-2 px-2 border mt-1 w-full" type="email" name="email"
            ...
            <div class="mt-4 flex gap-2">
                <div class="">
                    ...
                    <x-input id="password" class="block py-2 px-2 border mt-1 w-full" type="password" name="password"
                        required autocomplete="new-password" />
                </div>

                <div class="">
                    <x-label for="password_confirmation" value="{{ __('Confirm Password') }}" />
                    <x-input id="password_confirmation" class="block py-2 px-2 border mt-1 w-full" type="password"
