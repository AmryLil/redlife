<div>
    ...
    <div class="min-h-screen w-screen">
        ...
        <x-waves></x-waves>
        <h1 class="absolute top-40 font-boldonse left-32 font-bold text-slate-50 text-4xl uppercase">Lokasi Donor</h1>
        <div id="mapStatus"
        ...
        <div class="container mx-auto px-4 py-8 max-w-7xl">
            ...
            <div class="grid grid-cols-1 xl:grid-cols-3 gap-8">
                ...
                <div class="space-y-6">
                    <!-- Location Selector -->
                    <div id="locationSelector" class="glass-effect rounded-2xl p-6 floating-card"
                        style="display: none;">
